...
@section('content')
    <div class="lg:w-[373px] w-full mx-auto lg:border rounded-lg p-6 py-8 mt-10">
        ...
        <h2 class="font-medium text-xl text-center">Mot de passe oublié</h2>
        <p class="text-center mt-2 text-sm">Vous allez recevoir un e-mail pour ajouter un mot de passe à votre compte.</p>
        <div class="mt-6">
