        ...
        <ul class="space-y-2 font-medium">
            ...
            <li class="{{request()->routeIs('admin.vehicules.*')?'active':''}}">
                <a href="{{route('admin.vehicules.index')}}" class="group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Véhicules</span>
                </a>
            </li>
            <li class="{{request()->routeIs('admin.auctions.*')?'active':''}}">
                <a href="{{route('admin.auctions.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Enchères</span>
                </a>
            </li>
            <li class="{{request()->routeIs('admin.equipments.*')||request()->routeIs('admin.options.*')||request()->routeIs('admin.energies.*')||request()->routeIs('admin.colors.*')?'active':''}}">
                <a type="button" href="#" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between w-full">
                        <span class="flex-1 ms-3 whitespace-nowrap">Caractéristique</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                        </svg>
                    </div>
                </a>
                <ul id="dropdown-example" class="{{request()->routeIs('admin.equipments.*')||request()->routeIs('admin.options.*')||request()->routeIs('admin.energies.*')||request()->routeIs('admin.colors.*')?'':'hidden'}} py-2 space-y-2 px-4 text-sm">
                      <li class="{{request()->routeIs('admin.equipments.*')?'active':''}}">
                         <a href="{{route('admin.equipments.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Equipements</a>
                      </li>
                      <li class="{{request()->routeIs('admin.options.*')?'active':''}}">
                        <a href="{{route('admin.options.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Options</a>
                     </li>
                      <li class="{{request()->routeIs('admin.energies.*')?'active':''}}">
                         <a href="{{route('admin.energies.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Énergies</a>
                      </li>
                      <li class="{{request()->routeIs('admin.colors.*')?'active':''}}">
                        <a href="{{route('admin.colors.index')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Couleurs</a>
                     </li>
                </ul>
             </li>
            {{-- <li class="{{request()->routeIs('admin.equipments.*')?'active':''}}">
                <a href="{{route('admin.equipments.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Equipements</span>
                </a>
            </li>
            <li class="{{request()->routeIs('admin.options.*')?'active':''}}">
                <a href="{{route('admin.options.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li class="{{request()->routeIs('admin.energies.*')?'active':''}}">
                <a href="{{route('admin.energies.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.122 17.645a7.185 7.185 0 0 1-2.656 2.495 7.06 7.06 0 0 1-3.52.853 6.617 6.617 0 0 1-3.306-.718 6.73 6.73 0 0 1-2.54-2.266c-2.672-4.57.287-8.846.887-9.668A4.448 4.448 0 0 0 8.07 6.31 4.49 4.49 0 0 0 7.997 4c1.284.965 6.43 3.258 5.525 10.631 1.496-1.136 2.7-3.046 2.846-6.216 1.43 1.061 3.985 5.462 1.754 9.23Z"/>
                    </svg>                                         
                    <span class="flex-1 ms-3 whitespace-nowrap">Énergies</span>
                </a>
            </li> --}}
            {{-- <li class="{{request()->routeIs('admin.colors.*')?'active':''}}">
            ...
            <li class="{{request()->routeIs('admin.pages.*')?'active':''}}">
                <a href="{{route('admin.pages.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">{{__("Pages")}}</span>
                    {{-- <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span> --}}
                </a>
            </li>
            <li class="{{request()->routeIs('admin.menus.*')?'active':''}}">
                <a href="{{route('admin.menus.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li class="{{request()->routeIs('admin.contacts.*')?'active':''}}">
                <a href="{{route('admin.contacts.index')}}" class="group">
                    <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m3.5 5.5 7.893 6.036a1 1 0 0 0 1.214 0L20.5 5.5M4 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z"/>
                      </svg>
                    <span class="flex-1 ms-3 whitespace-nowrap">Contacts</span>
                    <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">{{App\Models\Contact::count()}}</span>
                </a>
            </li>
