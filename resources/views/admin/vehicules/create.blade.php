...
<div>
    ...
    <form action="{{route('admin.vehicules.store')}}" method="post" enctype="multipart/form-data">
        ...
        <button onclick="this.querySelector('.loading').classList.remove('hidden');" type="submit" class="text-white flex w-max mt-4 items-center gap-2.5 bg-primary hover:bg-primaryHover focus:ring-4 focus:outline-none focus:ring-primaryLight font-medium rounded-lg text-sm px-5 py-2.5 text-center">
