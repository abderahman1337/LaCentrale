...
<div>
    ...
    <form action="{{route('admin.vehicules.update', $vehicule->id)}}" method="post" enctype="multipart/form-data">
        ...
        <button onclick="this.querySelector('.loading').classList.remove('hidden');" type="submit" class="text-white flex gap-2.5 w-max mt-4 items-center bg-primary hover:bg-primaryHover focus:ring-4 focus:outline-none focus:ring-primaryLight font-medium rounded-lg text-sm px-5 py-2.5 text-center">
