...
<div>
    <div class="flex items-center justify-between">
        <h2 class="lg:text-2xl text-xl font-bold">Les couleurs <span class="text-primary">({{$colors->total()}})</span></h2>
        <!-- New Brand -->
    ...
    <div class="mt-6">
        <form method="GET" action="{{route('admin.colors.index')}}" class="w-full mx-auto mb-4">
            <div class="flex">
                <label for="search-input" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Couleur</label>
