                  ...
                  <div class="bg-[#fcfcfc] dark:bg-darkBg dark:border-gray-300 dark:border-opacity-10 rounded-md cursor-move shadow-sm border-[#e5e5e5] border menu-item-box" data-id="{{$menuItem->id}}" id="menu-item-{{$key+1}}">
                     <div class="px-[20px] py-[15px]">
                        <div class="flex items-center flex-col lg:flex-row gap-4 w-full">
                           ...
                           <div class="w-full">
                              <div class="relative">
                                 <input type="text" name="menu_items[{{$key}}][link]" id="menu-item-link-{{$key+1}}" value="{{old('menu_items.'.$key.'.link', $menuItem->link)}}" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
